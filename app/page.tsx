      ...
      >
        <div className="md:w-1/2 space-y-5">
          ...
          <p className="text-md text-gray-300 leading-normal">
            AI Collective Hub brings together individuals passionate about
      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-10">
          <Card
            ...
            cardTitle="Collaborative Projects"
            cardContent="Access resources, courses, and workshops to build your AI/ML skills."
          />
          <Card
            svgComponent={
              <svg
