...
export default function Home() {
  ...
  const opportunities = [
    ...
    },
    {
      ...
      description: "Attend live sessions and gain hands-on experience with the latest tools and technologies",
    },
    {
      id: 3,
      title: "Project Incubator",
      image: "/bootcamp.jpg", // Ensure this path is correct
      description: "Bring your ideas to life with support from our community and resources",
    },
  ];
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-4 py-8">
<TeamCard name="Gifty Asamoah" role="Organizer" imageUrl="/profile1.jpg" linkedinUrl=""/>
          <TeamCard name="Selasie Sepenu" role="Co-Organizer & UG Chapter Lead" imageUrl="/profile2.jpg" linkedinUrl=""/>
          <TeamCard name="Peter Essibul" role="UCC Chapter Lead" imageUrl="/profile1.jpg" linkedinUrl=""/>
</div>
